...
class TestHubSpot:
    client = HubSpot(base_url=base_url, access_token=access_token, _strict_response_validation=True)
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = HubSpot(base_url=base_url, access_token=access_token, _strict_response_validation=False)
...
class TestAsyncHubSpot:
    ...
    def test_base_url_trailing_slash(self, client: AsyncHubSpot) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncHubSpot) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncHubSpot) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncHubSpot(base_url=base_url, access_token=access_token, _strict_response_validation=False)
