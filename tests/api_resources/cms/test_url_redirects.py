...
class TestURLRedirects:
    ...
    def test_method_list(self, client: HubSpot) -> None:
        ...
        assert_matches_type(SyncCursorURLPage[URLMapping], url_redirect, path=["response"])
...
class TestAsyncURLRedirects:
    ...
    async def test_method_list(self, async_client: AsyncHubSpot) -> None:
        ...
        assert_matches_type(AsyncCursorURLPage[URLMapping], url_redirect, path=["response"])
