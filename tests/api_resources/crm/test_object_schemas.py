...
class TestObjectSchemas:
    ...
    def test_method_create(self, client: HubSpot) -> None:
        ...
        assert_matches_type(CRMObjectSchema, object_schema, path=["response"])
    ...
    def test_method_update(self, client: HubSpot) -> None:
        ...
        assert_matches_type(CRMObjectTypeDefinition, object_schema, path=["response"])
    ...
    def test_method_list(self, client: HubSpot) -> None:
        ...
        assert_matches_type(CRMCollectionResponseObjectSchemaNoPaging, object_schema, path=["response"])
    ...
    def test_method_archive_association(self, client: HubSpot) -> None:
        object_schema = client.crm.object_schemas.archive_association(
    ...
    def test_raw_response_archive_association(self, client: HubSpot) -> None:
        response = client.crm.object_schemas.with_raw_response.archive_association(
            association_identifier="associationIdentifier",
            object_type="objectType",
        )
    ...
    def test_streaming_response_archive_association(self, client: HubSpot) -> None:
        with client.crm.object_schemas.with_streaming_response.archive_association(
            association_identifier="associationIdentifier",
            object_type="objectType",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_archive_association(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_type` but received ''"):
            client.crm.object_schemas.with_raw_response.archive_association(
                association_identifier="associationIdentifier",
                object_type="",
            )
    ...
    def test_method_create_association(self, client: HubSpot) -> None:
        ...
        assert_matches_type(CRMAssociationDefinition, object_schema, path=["response"])
    ...
    def test_method_read(self, client: HubSpot) -> None:
        object_schema = client.crm.object_schemas.read(
            "objectType",
        )
        assert_matches_type(CRMObjectSchema, object_schema, path=["response"])
    ...
    def test_raw_response_read(self, client: HubSpot) -> None:
        response = client.crm.object_schemas.with_raw_response.read(
            "objectType",
        )
    ...
    def test_streaming_response_read(self, client: HubSpot) -> None:
        with client.crm.object_schemas.with_streaming_response.read(
            "objectType",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_read(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_type` but received ''"):
            client.crm.object_schemas.with_raw_response.read(
                "",
            )
...
class TestAsyncObjectSchemas:
    ...
    async def test_method_archive_association(self, async_client: AsyncHubSpot) -> None:
        object_schema = await async_client.crm.object_schemas.archive_association(
            association_identifier="associationIdentifier",
            object_type="objectType",
        )
        assert object_schema is None
    ...
    async def test_raw_response_archive_association(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.crm.object_schemas.with_raw_response.archive_association(
            association_identifier="associationIdentifier",
            object_type="objectType",
        )
    ...
    async def test_streaming_response_archive_association(self, async_client: AsyncHubSpot) -> None:
        async with async_client.crm.object_schemas.with_streaming_response.archive_association(
            association_identifier="associationIdentifier",
            object_type="objectType",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_archive_association(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_type` but received ''"):
            await async_client.crm.object_schemas.with_raw_response.archive_association(
                association_identifier="associationIdentifier",
                object_type="",
            )
    ...
    async def test_method_read(self, async_client: AsyncHubSpot) -> None:
        object_schema = await async_client.crm.object_schemas.read(
            "objectType",
        )
        assert_matches_type(CRMObjectSchema, object_schema, path=["response"])
    ...
    async def test_raw_response_read(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.crm.object_schemas.with_raw_response.read(
            "objectType",
        )
    ...
    async def test_streaming_response_read(self, async_client: AsyncHubSpot) -> None:
        async with async_client.crm.object_schemas.with_streaming_response.read(
            "objectType",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_read(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_type` but received ''"):
            await async_client.crm.object_schemas.with_raw_response.read(
                "",
            )
