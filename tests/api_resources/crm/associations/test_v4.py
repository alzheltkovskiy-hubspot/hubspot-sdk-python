...
class TestV4:
    ...
    def test_method_list(self, client: HubSpot) -> None:
        ...
        assert_matches_type(SyncCursorURLPage[MultiAssociatedObjectWithLabel], v4, path=["response"])
...
class TestAsyncV4:
    ...
    async def test_method_list(self, async_client: AsyncHubSpot) -> None:
        ...
        assert_matches_type(AsyncCursorURLPage[MultiAssociatedObjectWithLabel], v4, path=["response"])
