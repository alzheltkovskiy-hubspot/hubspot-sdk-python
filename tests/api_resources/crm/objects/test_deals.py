...
class TestDeals:
    ...
    def test_method_list(self, client: HubSpot) -> None:
        ...
        assert_matches_type(SyncCursorURLPage[SimplePublicObjectWithAssociations], deal, path=["response"])
...
class TestAsyncDeals:
    ...
    async def test_method_list(self, async_client: AsyncHubSpot) -> None:
        ...
        assert_matches_type(AsyncCursorURLPage[SimplePublicObjectWithAssociations], deal, path=["response"])
