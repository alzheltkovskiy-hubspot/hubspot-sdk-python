...
from .crm_objects_collection_response_associated_id import CRMObjectsCollectionResponseAssociatedID

__all__ = ["CRMObjectsSimplePublicObjectWithAssociations"]


class CRMObjectsSimplePublicObjectWithAssociations(BaseModel):
    id: str
    ...
    associations: Optional[Dict[str, CRMObjectsCollectionResponseAssociatedID]] = None
