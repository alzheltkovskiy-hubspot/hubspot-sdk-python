...
from .crm_property_modification_metadata import CRMPropertyModificationMetadata
...
class CRMProperty(BaseModel):
    ...
    modification_metadata: Optional[CRMPropertyModificationMetadata] = FieldInfo(
