...
from .marketing_emails_public_button_style_settings import MarketingEmailsPublicButtonStyleSettings
from .marketing_emails_public_divider_style_settings import MarketingEmailsPublicDividerStyleSettings

__all__ = ["MarketingEmailsPublicEmailStyleSettings"]


class MarketingEmailsPublicEmailStyleSettings(BaseModel):
    ...
    button_style_settings: Optional[MarketingEmailsPublicButtonStyleSettings] = FieldInfo(
        alias="buttonStyleSettings", default=None
    )
    ...
    divider_style_settings: Optional[MarketingEmailsPublicDividerStyleSettings] = FieldInfo(
        alias="dividerStyleSettings", default=None
    )
    ...
    heading_one_font: Optional[MarketingEmailsPublicFontStyle] = FieldInfo(alias="headingOneFont", default=None)

    heading_two_font: Optional[MarketingEmailsPublicFontStyle] = FieldInfo(alias="headingTwoFont", default=None)

    links_font: Optional[MarketingEmailsPublicFontStyle] = FieldInfo(alias="linksFont", default=None)
