...
from .marketing_emails_public_email_style_settings import MarketingEmailsPublicEmailStyleSettings

__all__ = ["MarketingEmailsPublicEmailContent"]


class MarketingEmailsPublicEmailContent(BaseModel):
    ...
    style_settings: Optional[MarketingEmailsPublicEmailStyleSettings] = FieldInfo(alias="styleSettings", default=None)
