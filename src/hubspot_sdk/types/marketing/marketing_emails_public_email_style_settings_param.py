...
from .marketing_emails_public_button_style_settings_param import MarketingEmailsPublicButtonStyleSettingsParam
from .marketing_emails_public_divider_style_settings_param import MarketingEmailsPublicDividerStyleSettingsParam

__all__ = ["MarketingEmailsPublicEmailStyleSettingsParam"]


class MarketingEmailsPublicEmailStyleSettingsParam(TypedDict, total=False):
    ...
    button_style_settings: Annotated[
        MarketingEmailsPublicButtonStyleSettingsParam, PropertyInfo(alias="buttonStyleSettings")
    ]
    ...
    divider_style_settings: Annotated[
        MarketingEmailsPublicDividerStyleSettingsParam, PropertyInfo(alias="dividerStyleSettings")
    ]
    ...
    heading_one_font: Annotated[MarketingEmailsPublicFontStyleParam, PropertyInfo(alias="headingOneFont")]

    heading_two_font: Annotated[MarketingEmailsPublicFontStyleParam, PropertyInfo(alias="headingTwoFont")]

    links_font: Annotated[MarketingEmailsPublicFontStyleParam, PropertyInfo(alias="linksFont")]
