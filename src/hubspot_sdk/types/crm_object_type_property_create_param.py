...
from .crm.crm_properties_option_input_param import CRMPropertiesOptionInputParam

__all__ = ["CRMObjectTypePropertyCreateParam"]


class CRMObjectTypePropertyCreateParam(TypedDict, total=False):
