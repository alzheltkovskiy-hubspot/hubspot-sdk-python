        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"archived": archived}, object_schema_list_params.ObjectSchemaListParams),
            ),
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                query=await async_maybe_transform(
                    {"archived": archived}, object_schema_list_params.ObjectSchemaListParams
                ),
            ),
            cast_to=CRMCollectionResponseObjectSchemaNoPaging,
        )
...
class ObjectSchemasResourceWithRawResponse:
    def __init__(self, object_schemas: ObjectSchemasResource) -> None:
        ...
        self.archive_association = to_raw_response_wrapper(
            object_schemas.archive_association,
        )
